...
RnsShell::LayerInvalidateMask  RSkComponentRNSVGRect::updateComponentProps(const ShadowView &newShadowView,bool forceUpdate) {
  ...
  setLengthAttribute(selfNode,SkSVGAttribute::kX,newRNSVGRectProps.x.c_str());
  setLengthAttribute(selfNode,SkSVGAttribute::kY,newRNSVGRectProps.y.c_str());
  setLengthAttribute(selfNode,SkSVGAttribute::kRx,newRNSVGRectProps.rx.c_str());
  setLengthAttribute(selfNode,SkSVGAttribute::kRy,newRNSVGRectProps.ry.c_str());
  setLengthAttribute(selfNode,SkSVGAttribute::kWidth,newRNSVGRectProps.width.c_str());
  setLengthAttribute(selfNode,SkSVGAttribute::kHeight,newRNSVGRectProps.height.c_str());

  updateCommonNodeProps(newRNSVGRectProps,*this,selfNode);
